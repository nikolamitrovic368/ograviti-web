...
export default function JourneyCarousel(
  ...
  return (
    <div>
      ...
      >
        <div className="mt-6 ml-0 flex md:ml-28 2xl:mt-12">
            ...
            (_step, key) => (
              ...
              >
                <div className="md:mr-12">
                  <div
                    className={cn(
                      'h-32 rotate-180 cursor-pointer px-4 text-right text-lg transition-all [writing-mode:vertical-lr] 2xl:h-44 2xl:text-2xl',
